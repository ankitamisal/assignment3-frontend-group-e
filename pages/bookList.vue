        ...
        <div>
            <form method="post" class="bg-gray-100 border-black rounded-lg border-2 px-12">
                <table>
                    ...
                    <span v-for="error in v$.book_name.$errors" :key="error.$uid" class=" text-red-700">{{
                         error.$message 
                        }}</span>
                    <br /><br />
                    ...
                    <span v-for="error in v$.book_number.$errors" :key="error.$uid" class=" text-red-700">{{
                         error.$message 
                        }}</span>
          ...
          Get Data
            ...
            <table>
                <tr>
                    <th class="px-4 border-black rounded-lg border-2">Language ID</th>
                    <th class="px-4 border-black rounded-lg border-2">Language</th>
                </tr>
                <tbody>
                    <tr v-for="(item, index) of state.getLanguage" :key="item.id">
                        <td class="px-4 border-black rounded-lg border-2">{{  item.Language_id  }}</td>
                        <td class="px-4 border-black rounded-lg border-2">{{  item.Language  }}</td>
...
async function getBookAPI() {
    ...
    state.getLanguage = await $fetch('http://localhost:3001/language');
}
